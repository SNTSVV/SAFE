...
public class SolutionListComparator<S extends Solution<?>> implements Comparator<S>, Serializable {
	...
	public int compare(S solution1, S solution2) {
		...
		if (solution1 == null) {
			...
			double[] objective1 = (double[])solution1.getAttribute("FitnessList");//ObjectiveList(this.objectiveId);
			double[] objective2 = (double[])solution2.getAttribute("FitnessList");//.getObjectiveList(this.objectiveId);
			double value = 0.0;
